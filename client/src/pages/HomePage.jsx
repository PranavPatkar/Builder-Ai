...
const {user, projects, loadingProjects, generatingProject, loadProjects, handleGenerate,
  ...
  return (
    ...
    bg-cover bg-center bg-no-repeat">
      ...
      {/* {Hero} */}
    <div  className='flex-1 flex flex-col items-center justify-center px-6 pb-20 mt-8 lg:mt-28'>
                        ...
                        <span className='text-xs text-zinc-100 font-normal'>
                          {projects.length} {projects.length === 1 ? "project" : "projects"}
                            ...
                            {projects.map((p)=>(
                              ...
                              py-3 flex items-center justify-between group hover:border-white/20 hover:bg-white/10
