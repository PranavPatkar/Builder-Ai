            ...
            <div key={i}>
                <div className='flex gap-2.5 items-start'>
                    <div className='shrink-0 w-6 h-6 rounded-md flex items-center justify-center mt-0.5 bg-zinc-50'>
                        {msg.role === 'user' ?(
                            <UserIcon size={14} className='text-zinc-500'></UserIcon>
                        ): (
                            <BotMessageSquareIcon size={14} className='text-zinc-700'></BotMessageSquareIcon>
                        )}
                    </div>
        ...
        {loading && (
            <div className='flex gap-2.5 items-start'>
                <div className='shrink-0 w-6 h-6 rounded-md flex items-center justify-center mt-0.5 bg-zinc-900/5'>
                    <BotIcon size={13} className='text-zinc-900'></BotIcon>
                </div>
