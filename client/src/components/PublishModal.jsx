  ...
  <div className="bg-white border border-zinc-200 shadow-lg rounded-xl max-w-md w-full p-6 mx-4 relative">
    ...
    <div className='mb-6'>
      <h3 className='text-lg font-medium text-zinc-900 mb-1'>
        Your website is live!</h3>
      <p className='text-sm text-zinc-500'>Anyone with the link can view your published site.</p>
    </div>
    ...
    <div className='space-y-4'>
          ...
          <div className='flex gap-2 pt-2'>
               <button
                  onClick={handleCopyLink} className="flex-1 py-2 bg-zinc-950 text-white 
                  text-xs font-medium hover:bg-zinc-800 cursor-pointer rounded-lg text-center">
                  Copy Link
                </button>

                <button onClick={()=>window.open(publishUrl, '_blank')} className="flex-1 py-2 border border-zinc-200 text-zinc-700 
                text-xs font-medium hover:bg-zinc-50 cursor-pointer rounded-lg text-center">
                Open Site
                </button>
          </div>
    </div>
