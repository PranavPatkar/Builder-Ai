...
export async function createProject(req, res) {
    ...
    //Start background geeneration.
    runBackgroundGeneration(project._id.toString(), prompt).catch((err)=>{
        console.error(`[Background AI] Fatal generation error for projects
            ${project._id}:`,err)
    })
...
// GET /api/projects
//List all the projects owned by user(summary only, no file contents).
